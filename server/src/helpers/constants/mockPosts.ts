export const mockPosts = [
  {
    title: 'The Westminster Dog Show of superheroes',
    author: '64591cf96b7f6ac983dc7ee1',
    reviewedItem: 'Avengers',
    group: 'Movies',
    tags: ['645cead0039ec751376f0111', '645cead0039ec751376f0110'],
    body: "One of the weapons Marvel used in its climb to comic-book dominance was a willingness to invent new characters at a dizzying speed. There are so many Marvel universes, indeed, that some superheroes do not even exist in one another's worlds, preventing gridlock. The Avengers however do share the same time and space continuum, although in recent years, they've been treated in separate, single-superhero movies. One assumes the idle Avengers follow the exploits of the employed ones on the news.",
    imageUrl:
